...
# 4. 所有容器间通信使用Docker服务名(es-worldlora:9200, kafka:29092)，不使用localhost
# 5. 测试脚本从Flink容器内部执行：docker exec -it starcompass-flink-taskmanager-1 bash -c "cd /opt/flink/usrlib && python test_es_sink.py"
# ========================================================================================
